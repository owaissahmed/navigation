      ...
      <View style={Styles.third_div}>
        <ImageBackground
          ...
          <ImageBackground
            ...
            <Image style={Styles.thin} source={require('../images/thin.png')} />
          </ImageBackground>
        </ImageBackground>
      </View>
        ...
        <View style={Styles.smldiv}>
          <TouchableOpacity style={Styles.cart}>
            <LinearGradient
              ...
              <Text style={Styles.smal}>Small</Text>
            </LinearGradient>
          </TouchableOpacity>
          <Text onPress={gotomedium} style={Styles.medium}>
            Medium
          </Text>
