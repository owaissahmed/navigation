        ...
        <View style={Styles.smldiv}>
          ...
          <TouchableOpacity style={Styles.cart}>
            <LinearGradient
              ...
              <Text style={Styles.smal}>Thick</Text>
            </LinearGradient>
          </TouchableOpacity>
        </View>
      </View>
